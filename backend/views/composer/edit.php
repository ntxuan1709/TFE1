<div class='box'>
	<div class='box-header'>
		<h2 class='box-title'>Sửa nhạc sĩ</h2>
	...
	<div class='box-body'>
		...
		<form action="?controller=<?php echo $_GET['controller'] ?>&act=update" method="post">
			<div class="col-md-7">
				<input type="hidden" name="composerid" value="<?php echo $row['composerid'] ?>">

				<div class="form-group">
					<label for="composername">Tên nhạc sĩ</label>
					<input type="text" name="composername" class="form-control" id="composername" value="<?php echo $row['composername'] ?>" placeholder="Nhập tên nghệ sĩ">
				</div>
				...
				<div class="form-group">
					...
					value="<?php echo $row['birthday']?>" id="birthday" placeholder="Nhập ngày sinh">
				</div>
