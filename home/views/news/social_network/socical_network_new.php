<div id="social_network_new" class="tokyo_tm_section">
    <div class="box_inner">
        <div class="description_wrap">
            <div class="image">
                <img src="home/assets/images/slider/elderly-technology.jpg" alt="">
            </div>
            <div class="details">
                <div class="extra">
                    ...
                    <div class="my_like custom_size">
                        <a href="#"><img class="svg" src="home/assets/images/svg/like.svg" alt=""><span>35</span></a>
                    </div>
                </div>
                <h3 class="title custom_size">Format releases a new tool that enables direct video hosting</h3>
                <div class="tokyo_tm_read_more custom_size">
